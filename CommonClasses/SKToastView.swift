...
public class SKToast: NSObject {
    ...
    fileprivate var messageFont              : UIFont            = UIFont.systemFont(ofSize  : 15, weight  : .regular)
    ...
    fileprivate func setToastViewSize() {
        ...
        if let statusMessage =  statusLabel?.text, statusMessage.count != 0 {
            ...
            rectLabel = (statusLabel?.text?.boundingRect(with: CGSize(width: toastViewWidth-5, height: 300),
